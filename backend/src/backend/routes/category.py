...
def get_category_details(
    ...
    category = category_service.get_category_by_id(db, category_id, user_id)
...
def update_category_details(
    ...
    category = category_service.update_category_by_id(
        db, category_id, category, user_id
    )
    if category is None:
        raise HTTPException(
            status_code=status.HTTP_404_NOT_FOUND, detail="Category not found"
...
def delete_category(
    ...
    category_service.delete_category_by_id(db, category_id, user_id)
