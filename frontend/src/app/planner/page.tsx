...
//     try {
//       const token = localStorage.getItem('access_token'); // Adjust if you're storing the token under a different key
...
//       // Add new event to calendar view
//       setEvents([...events, {
